...
This project is free to use, modify, and distribute. However, you are **not permitted** to sell this app or any derivative work. For details, see the [LICENSE](LICENSE) file.
